...
/*Try to read the ID register from the TMP468 by sending a write-read transaction to the I2C master.*/
...
/*True, if the response data is equal to 0x190. See TMP468 datasheet section: 7.5.1.7 Identification Register*/

/*Generated with CHSM v0.0.0 at 2023.05.30 14.24.23*/
#include "cevent.h"
#include "chsm.h"
#include "lm73.h"
...
static chsm_result_ten s_read_id_reg(chsm_tst *self, const cevent_tst  *e_pst)
{
    switch(e_pst->sig)
    {
        case SIG_I2C_RESULT_ADDR_NACK:
            debug_log_func(self, e_pst, "SIG_I2C_RESULT_ADDR_NACK", __FUNCTION__);
            lm73_reset_timer(self, e_pst);
            return chsm_transition(self, s_unplugged);

        case SIG_I2C_RESULT_DATA_NACK:
            debug_log_func(self, e_pst, "SIG_I2C_RESULT_DATA_NACK", __FUNCTION__);
            lm73_reset_timer(self, e_pst);
            return chsm_transition(self, s_unplugged);

        case SIG_I2C_RESULT_SUCCESS:
            debug_log_func(self, e_pst, "SIG_I2C_RESULT_SUCCESS", __FUNCTION__);
        ...
        case SIG_SYS_TICK_10ms:
            debug_log_func(self, e_pst, "SIG_SYS_TICK_10ms", __FUNCTION__);
...
static chsm_result_ten s_idle(chsm_tst *self, const cevent_tst  *e_pst)
{
    ...
    {
        case SIG_LM73_READ:
            debug_log_func(self, e_pst, "SIG_LM73_READ", __FUNCTION__);
            lm73_start_read(self, e_pst);
            return chsm_transition(self, s_reading);
...
chsm_result_ten lm73_top(chsm_tst *self, const cevent_tst  *e_pst)
{
    ...
    {
        case C_SIG_INIT:
            debug_log_func(self, e_pst, "C_SIG_INIT", __FUNCTION__);
...
debug_log_func(chsm_tst *self, const cevent_tst *est, uint8_t *trans_name, uint8_t *state_func) 
{

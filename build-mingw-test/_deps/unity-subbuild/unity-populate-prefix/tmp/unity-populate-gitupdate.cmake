...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "67ca5c57c9c50cc1580518cc6f822558c0009b1e"
  WORKING_DIRECTORY "C:/GIT/WORK/Gabor/paper_dispenser/fw/c/externals/chsm/unity"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "67ca5c57c9c50cc1580518cc6f822558c0009b1e")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("67ca5c57c9c50cc1580518cc6f822558c0009b1e" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/67ca5c57c9c50cc1580518cc6f822558c0009b1e")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/GIT/WORK/Gabor/paper_dispenser/fw/c/externals/chsm/unity'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/GIT/WORK/Gabor/paper_dispenser/fw/c/externals/chsm/unity'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

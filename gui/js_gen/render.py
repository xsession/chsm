"""
JavaScript state machine code generator for CHSM.

Usage:
    render.py <html_file> [--output=<file>] [--class-name=<name>]

Generates a JavaScript (ES6) state machine class from a CHSM drawing (.html) file.
"""
import sys
import os
import json
...
TEMPLATE_NAME = 'chsm_js_template.jinja'
...
def render(model, template_params=None):
    """Render a JavaScript state machine from a CHSM model dict.
    ...
    Returns:
        Generated JavaScript source code as a string.
    """
